...
**Walkthrough**
- Can be found [here!](<https://github.com/Ali-Mikael/Application-hacking/blob/main/h2-BreakAndFix.md#c-dirfuzt-1>)
...
# B) Target Practise
**Objective**
- Install the FuffMe-target
- Instructions [here](<https://terokarvinen.com/2023/fuffme-web-fuzzing-target-debian/>)
