...
- P) [Metasploitable 3](<https://github.com/Ali-Mikael/Pen-testing/blob/main/h3-EternalExploit.md#p-metasploitable3>)

**H4**
- J) [Pencode](<https://github.com/Ali-Mikael/Pen-testing/blob/main/h4-cert.md#j-pencode>)
- K) [Mitmproxy](<https://github.com/Ali-Mikael/Pen-testing/blob/main/h4-cert.md#k-mitmproxy>)
- L) [Bonus Portswigger Lab](<https://github.com/Ali-Mikael/Pen-testing/blob/main/h4-cert.md#l-arbitrary-portswigger-lab>) (this one I didn't complete 100% as there was a section I coulnd't get past)



# B) Improved tasks
[H6](<https://github.com/Ali-Mikael/Pen-testing/blob/main/h6-shells.md>) Somebody (alway) complained about sources, so I made references more clearer. If I remember correctly, if you have all sources written down, you don't need to do a complete listing at the end, as long as it's clear in the text what piece of information you took from where. This is the logic I've been using, but I finally had enough so I spent like 40 minutes trying to do the sources and references as well as I possibly could, so that it follows the criteria:
- Clear and easy to follow what source was used and where
- Doesn't clutter the rest of the text
- Easy to look up
...
<img width="1390" height="585" alt="2026-05-10-19:06:36" src="https://github.com/user-attachments/assets/6b276c10-2aba-4815-ae9d-5246d5d42b0e" />
